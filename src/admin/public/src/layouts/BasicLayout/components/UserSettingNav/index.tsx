...
import { getUserSettingMenuConfig } from '@/constants/navConfig';
...
const Navigation = (props, context) => {
  ...
  const asideMenuConfig: any = getUserSettingMenuConfig({ orgName })[pathname];
...
const UserSettingNav = withRouter(Navigation);
