...
import { getEnvironmentMenuConfig } from '@/constants/navConfig';
...
const Navigation = (props, context) => {
  ...
  const asideMenuConfig: any = getEnvironmentMenuConfig({ orgName, pathname })[pathname];
...
const EnvNav = withRouter(Navigation);
